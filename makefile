...
OBJS = avr-stuff/util/uart/uart.o LightController.o ReflexProgram.o ButtonManager.o MenuProgram.o
...
main.o : main.cpp LightController.o ReflexProgram.o ButtonManager.o MenuProgram.o
